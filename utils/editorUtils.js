...
exports.getAllEditorLines = getAllEditorLines;
exports.replaceTaskBlock = replaceTaskBlock;
/**
 ...
 */
function getAllEditorLines(editor) {
 ...
 */
function replaceTaskBlock(editor, startLine, endLine, replacementText) {
