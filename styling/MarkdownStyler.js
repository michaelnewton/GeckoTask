...
exports.updateMarkdownViewStyling = updateMarkdownViewStyling;
exports.styleTaskFieldsInMarkdown = styleTaskFieldsInMarkdown;
 ...
 */
function updateMarkdownViewStyling(app, settings, file) {
    app.workspace.iterateAllLeaves((leaf) => {
        if (leaf.view instanceof obsidian_1.MarkdownView) {
            ...
            if (viewFile && (0, areaUtils_1.isInTasksFolder)(viewFile.path, settings)) {
 ...
 */
function styleTaskFieldsInMarkdown(element) {
