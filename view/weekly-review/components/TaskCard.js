...
exports.renderTaskCard = renderTaskCard;
const obsidian_1 = require("obsidian");
const CaptureModal_1 = require("../../../ui/CaptureModal");
/**
 * Renders a task card with action buttons.
 */
async function renderTaskCard(host, app, settings, task, callbacks, options = {}) {
    ...
    if (isInbox) {
        ...
        (0, obsidian_1.setIcon)(completeBtn, "square-check");
        ...
        (0, obsidian_1.setIcon)(somedayBtn, "moon");
        ...
        (0, obsidian_1.setIcon)(projectBtn, "folder");
        ...
        (0, obsidian_1.setIcon)(editBtn, "pencil");
        ...
        editBtn.addEventListener("click", async () => {
            await (0, CaptureModal_1.captureQuickTask)(app, settings, task);
            await callbacks.onRerender();
        });
        // Delete
        ...
        (0, obsidian_1.setIcon)(deleteBtn, "trash-2");
    ...
    if (!isInbox) {
        ...
        (0, obsidian_1.setIcon)(moveBtn, "folder");
    ...
    if (isWaitingFor) {
        ...
        (0, obsidian_1.setIcon)(removeTagBtn, "x-circle");
