...
exports.calculateNextOccurrenceDates = calculateNextOccurrenceDates;
...
function calculateNextOccurrence(pattern, fromDate = new Date()) {
    ...
    if (daysMatch) {
        ...
        return (0, dateUtils_1.formatISODate)(next);
    }
 ...
 */
function findNextDayOfWeek(fromDate, targetDay, weeks = 1) {
 ...
 */
function isValidRecurrencePattern(pattern) {
 ...
 */
function calculateNextOccurrenceDates(recurPattern, fromDate, existingTask) {
