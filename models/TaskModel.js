...
exports.canonicalizeTaskForHash = canonicalizeTaskForHash;
exports.hashLine = hashLine;
exports.parseTaskWithDescription = parseTaskWithDescription;
exports.formatTaskWithDescription = formatTaskWithDescription;
...
function parseTask(line) {
    ...
    const parsedDue = dueValue ? ((0, NLDate_1.parseNLDate)(dueValue) ?? dueValue) : undefined;
    const t = {
        checked,
        title,
        tags,
 ...
 */
function withField(t, key, value) {
    return { ...t, [key]: value };
}
/**
 ...
 */
function canonicalizeTaskForHash(t) {
 ...
 */
function parseTaskWithDescription(lines, startLine) {
    const taskLine = lines[startLine];
    const task = parseTask(taskLine);
    if (!task)
        return { task: null, endLine: startLine };
 ...
 */
function formatTaskWithDescription(t) {
